...
var ParticipantForm = function (_React$Component) {
  _inherits(ParticipantForm, _React$Component);

  function ParticipantForm(props) {
    _classCallCheck(this, ParticipantForm);

    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(ParticipantForm).call(this, props));
    ...
    _this.handlePostAnswer = _this.handlePostAnswer.bind(_this);
    _this.handleOptionChange = _this.handleOptionChange.bind(_this);
    return _this;
  }

  _createClass(ParticipantForm, [{
    key: 'handlePostAnswer',
    value: function handlePostAnswer(event) {
      event.preventDefault();
      ...
      return React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(
            ...
            { name: 'options', className: 'options-wrapper well', onChange: this.handleOptionChange },
            this.props.questionOptions.map(function (currentValue, index, array) {
              return React.createElement(
                ...
                React.createElement(
                  'label',
                  null,
                  React.createElement(_reactRadioGroup.Radio, { value: currentValue }),
                  ' ',
                  currentValue
                )
              );
...
var UserLogout = function (_React$Component2) {
  _inherits(UserLogout, _React$Component2);

  function UserLogout() {
    _classCallCheck(this, UserLogout);

    return _possibleConstructorReturn(this, Object.getPrototypeOf(UserLogout).apply(this, arguments));
  }
...
},{"react":159,"react-dom":2,"react-radio-group":3,"urijs":162}]},{},[164]);
