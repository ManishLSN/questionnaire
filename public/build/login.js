...
var mountNode = document.getElementById('login-form');
  ...
  _createClass(LoginForm, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'div',
          { className: 'alert alert-warning alert-dismissible fade collapse', role: 'alert', id: 'alert-warning' },
          _react2.default.createElement(
            'button',
...
dpd.ques.get(function (result, err) {
  dpd.users.me(function (user) {
    if (user) {
      ...
      _reactDom2.default.render(_react2.default.createElement(LoginForm, { questionId: result[0].id }), mountNode);
    }
  });
});
