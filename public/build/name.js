...
var mountNode = document.getElementById('name-form');
...
var NameForm = function (_React$Component) {
  ...
  function NameForm(props) {
    ...
    return _possibleConstructorReturn(this, Object.getPrototypeOf(NameForm).call(this, props));
  }
  ...
  _createClass(NameForm, [{
    ...
    value: function componentDidMount() {
      $('form').submit(function (event) {
        ...
        var username = Math.random().toString(36).substr(2, 10);
        var password = Math.random().toString(36).substr(2, 7);
        // Dummy email id.
        var email = 'dummy@mailinator.com';
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement('input', { type: 'text', className: 'form-control', id: 'name', placeholder: 'Name', required: true })
          ),
          _react2.default.createElement(
            'div',
...
dpd.ques.get(function (result, err) {
  dpd.users.me(function (user) {
    if (user) {
      ...
      _reactDom2.default.render(_react2.default.createElement(NameForm, { questionId: result[0].id }), mountNode);
    }
  });
});
